...
/**
 * Custom hook for fetching bidders/enquiries for a specific listing
 */
export const useListingBidders = (listingId) => {
  return useQuery({
    queryKey: ["marketplace", "bidders", listingId],
    queryFn: () => marketplaceService.getListingBidders(listingId),
    enabled: !!listingId,
    staleTime: 30000, // 30 seconds
  });
};
