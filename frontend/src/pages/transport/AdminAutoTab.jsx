...
const AdminAutoTab = () => {
  ...
  const handleAddAuto = async (e) => {
    ...
    const form = e.target;
    const data = {
      auto_number: form.auto_number.value,
  ...
  /* Update Auto */
  const handleEditSave = async (e, auto_id) => {
    e.preventDefault();
    const form = e.target;
  ...
  /* Delete Auto */
  const handleDeleteAuto = async (auto_id) => {
  ...
  /* Status Update */
  const handleStatusUpdate = async (auto_id, status) => {
    try {
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button size="sm" variant="outline" className="flex items-center gap-1 border-gray-400">
                    ...
                    <Button
                      ...
                      onClick={() => handleDeleteAuto(auto.auto_id)}
                    >
                      🗑 Delete
                    </Button>
                  </div>
